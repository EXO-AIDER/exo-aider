classdef SppBluetooth < handle
    ...
    methods
        ...
        %
        function obj = SppBluetooth(name, board_task_name, buffer_size)
            obj.name = name;
            obj.channel = 1;
            obj.connect();
            obj.init(board_task_name, buffer_size);
        end
        ...
        function init(obj, board_task_name, buffer_size)
            ...
            obj.initialize_message_buffer(buffer_size);
            obj.initialize_signal_buffer(buffer_size);
        end
